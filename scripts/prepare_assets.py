...
run('-ss', '48', '-i', args.video, '-t', '9', '-an', '-vf', 'scale=960:-2', '-c:v', 'libx264', '-crf', '25', '-preset', 'medium', '-pix_fmt', 'yuv420p', '-movflags', '+faststart', root / 'static/videos/hero-loop.mp4')
...
print('Prepared paper, final video, hero loop, posters, and six paper figures.')
